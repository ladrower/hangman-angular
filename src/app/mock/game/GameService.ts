import { GameServiceInterface, response } from './GameServiceInterface';
import { UnauthenticatedException, UnknownEntryException, UnknownWordException } from './GameException';
